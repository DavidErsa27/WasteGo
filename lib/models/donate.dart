...
class DonationHistory {
  ...
  DonationHistory({required this.name, required this.amount, required this.donationDate}); 
}
...
var donateList = [
  Donate(
    ...
    status: 'Ongoing',
    donationHistory: [
      DonationHistory(name: 'Wahyu', amount: 'Rp 12,000', donationDate: '1 October 2025'),
      DonationHistory(name: 'Budi', amount: 'Rp 15,000', donationDate: '3 October 2025'),
      DonationHistory(name: 'Adi', amount: 'Rp 18,000', donationDate: '5 October 2025'),
      DonationHistory(name: 'Agus', amount: 'Rp 4,000', donationDate: '6 October 2025'),
      DonationHistory(name: 'Siti', amount: 'Rp 10,000', donationDate: '7 October 2025'),
      DonationHistory(name: 'Fajar', amount: 'Rp 8,000', donationDate: '8 October 2025'),
      DonationHistory(name: 'Rina', amount: 'Rp 13,000', donationDate: '9 October 2025'),
    ],
  ),
  Donate(
    ...
    status: 'Ongoing',
    donationHistory: [
      DonationHistory(name: 'John', amount: 'Rp 25,000', donationDate: '2 October 2025'),
      DonationHistory(name: 'Maria', amount: 'Rp 30,000', donationDate: '4 October 2025'),
      DonationHistory(name: 'Diana', amount: 'Rp 10,000', donationDate: '5 October 2025'),
      DonationHistory(name: 'Michael', amount: 'Rp 10,000', donationDate: '7 October 2025'),
      DonationHistory(name: 'Sarah', amount: 'Rp 5,000', donationDate: '8 October 2025'),
      DonationHistory(name: 'Mika', amount: 'Rp 15,000', donationDate: '9 October 2025'),
      DonationHistory(name: 'Siti', amount: 'Rp 21,000', donationDate: '10 October 2025'),
    ],
  ),
  Donate(
    ...
    status: 'Ongoing',
    donationHistory: [
      DonationHistory(name: 'Tina', amount: 'Rp 40,000', donationDate: '6 October 2025'),
      DonationHistory(name: 'Rina', amount: 'Rp 30,000', donationDate: '7 October 2025'),
      DonationHistory(name: 'Ali', amount: 'Rp 25,000', donationDate: '8 October 2025'),
      DonationHistory(name: 'Dani', amount: 'Rp 15,000', donationDate: '9 October 2025'),
      DonationHistory(name: 'Citra', amount: 'Rp 25,000', donationDate: '10 October 2025'),
      DonationHistory(name: 'Oki', amount: 'Rp 15,000', donationDate: '11 October 2025'),
      DonationHistory(name: 'Sari', amount: 'Rp 10,000', donationDate: '12 October 2025'),
    ],
  ),
  Donate(
    ...
    status: 'Ongoing',
    donationHistory: [
      DonationHistory(name: 'Tono', amount: 'Rp 40,000', donationDate: '2 October 2025'),
      DonationHistory(name: 'Sarah', amount: 'Rp 35,000', donationDate: '3 October 2025'),
      DonationHistory(name: 'Lia', amount: 'Rp 5,000', donationDate: '4 October 2025'),
      DonationHistory(name: 'Ika', amount: 'Rp 8,000', donationDate: '5 October 2025'),
      DonationHistory(name: 'Rani', amount: 'Rp 25,000', donationDate: '6 October 2025'),
      DonationHistory(name: 'Beni', amount: 'Rp 35,000', donationDate: '7 October 2025'),
      DonationHistory(name: 'Tina', amount: 'Rp 50,000', donationDate: '8 October 2025'),
    ],
  ),
];
